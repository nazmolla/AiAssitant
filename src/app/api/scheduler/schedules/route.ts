...
export async function POST(req: NextRequest) {
  ...
  if (!batchType || !["proactive", "knowledge", "cleanup"].includes(batchType)) {
    return NextResponse.json({ error: "batch_type must be one of proactive|knowledge|cleanup" }, { status: 400 });
  }
